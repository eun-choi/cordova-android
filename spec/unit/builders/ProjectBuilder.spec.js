...
describe('ProjectBuilder', () => {
    ...
    describe('installGradleWrapper', () => {
        ...
        it('should run gradle wrapper 8.14.3', async () => {
            await builder.installGradleWrapper('8.14.3');
            expect(execaSpy).toHaveBeenCalledWith('gradle', ['-p', path.normalize('/root/tools'), 'wrapper', '--gradle-version', '8.14.3'], jasmine.any(Object));
        });
