...
describe('ProjectBuilder', () => {
    ...
    describe('installGradleWrapper', () => {
        ...
        it('should run gradle wrapper 8.8', async () => {
            await builder.installGradleWrapper('8.8');
            expect(execaSpy).toHaveBeenCalledWith('gradle', ['-p', path.normalize('/root/tools'), 'wrapper', '--gradle-version', '8.8'], jasmine.any(Object));
        });
